    ...
    return (
        <section className="flex flex-col lg:flex-row w-full h-full p-3 md:p-5 gap-2 md:gap-4">
            <div className={`${secondDivContent ? 'w-full lg:w-1/2' : 'w-full'} h-full p-4 md:p-6 lg:p-10 text-amber-50`}>
                <h1 className="text-white/80 text-xl md:text-2xl lg:text-3xl mb-3 md:mb-4 font-montserratRegular">
                    Olá, eu sou o Wesley!
                </h1>
                <p className="text-white/80 font-montserratMediumItalic text-sm md:text-base lg:text-lg leading-relaxed">
